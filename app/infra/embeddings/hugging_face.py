...
class HuggingFaceEmbeddingProvider(BaseEmbeddingProvider):
    ...
    def __init__(self, client: AsyncInferenceClient, model: str, retrieval_instruction: str):
        self.client = client
        self.model = model
    ...
    @huggingface_retry(logger)
    async def embed_documents(self, documents: list[str] | str, batch_size: int | None = None, normalize: bool = True) -> list[float] | list[list[float]]:
