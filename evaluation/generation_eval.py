...
class GenerationEvaluator:
    ...
    def evaluate_reference_coverage(self,
        ...
        if total_points > 0:
            existing_points = sum(d["exists"] for d in output["points"])
            reference_coverage = existing_points/total_points

        else:
            existing_points = 0
            reference_coverage = 1
        
        return {"reference_coverage": reference_coverage, "existing_points": existing_points, "total_points": total_points} | output