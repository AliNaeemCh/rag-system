...
def generate_chunks_stats(path: Path | None = None, metadatas: list[dict] | None = None, chunk_size: int | None = None, chunk_overlap_pct: float | None = None):
    token_counts = []
    overlap_counts = []
    chapter_counts = defaultdict(int)

    if chunk_size and chunk_overlap_pct:
    ...
    def update_stats(metadata):
        ...
        overlap = metadata.get("total_overlap_tokens", 0)
    ...
    if path:
        ...
        raise Exception("Both 'path' and 'metadatas' can't be undefined!")
